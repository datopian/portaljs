      ...
      <div className="relative max-w-none w-full flex justify-center py-16 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-4xl px-4 sm:px-8 xl:px-12 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
            <a href="https://datahubproject.io" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">DataHub</a> is a powerful metadata platform, but its default UI can feel overwhelming for business users. PortalJS lets you craft tailored, branded experiences on top of <a href="https://datahubproject.io" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">DataHub</a> so every audience gets the context and navigation they need without changing your backend.
          </p>
        </div>
      </div>
      <div className="flex justify-center">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0b1830] via-[#10254a] to-[#173a78] px-7 py-12 text-center sm:px-14 sm:py-16">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-[30px] flex flex-wrap justify-center gap-3.5">
                <a
                  href="/book-a-demo?to=partner&source=datahub_cta"
                  target="_blank"
