...
export default function PortalJSvsDKAN() {
  ...
  const testimonials = [
    {
      quote: "DKAN's Drupal dependency was creating maintenance overhead and limiting our frontend possibilities. PortalJS gave us modern React capabilities while keeping our existing data infrastructure. Our development team's productivity doubled.",
      author: "Senior Developer",
      organization: "State Data Portal Team",
      image: null
    },
    {
      quote: "We were struggling with DKAN's complex Drupal customizations and slow performance. PortalJS delivered a faster, more maintainable solution with better user experience and significantly reduced hosting costs.",
      author: "IT Director",
      ...
      items: [
        {
          ...
          portaljs: "Modern React/Next.js with API-first architecture",
          competitor: "Drupal CMS with DKAN modules"
        },
        {
          feature: "Language & Runtime",
          portaljs: "JavaScript/TypeScript with Node.js ecosystem",
          competitor: "PHP with Drupal dependencies"
        },
        {
          feature: "Architecture Style",
          portaljs: "Decoupled frontend with API integration",
          competitor: "Monolithic Drupal application"
        },
        {
          feature: "Performance",
          portaljs: "Static generation with edge CDN delivery",
          competitor: "Server-rendered Drupal with database queries"
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          portaljs: "Modern web development skills (React/JS)",
          competitor: "Drupal expertise and module system knowledge"
        },
        {
          feature: "Development Speed",
          portaljs: "Rapid development with component libraries",
          competitor: "Slower due to Drupal complexity and dependencies"
        },
        {
          feature: "Security Updates",
          portaljs: "Frontend updates independent of data layer",
          competitor: "Complex Drupal core and module updates"
        },
        {
          feature: "Customization",
          portaljs: "Full control with React components",
          competitor: "Limited by Drupal theming and module constraints"
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          portaljs: "Lightning fast with pre-generated static pages",
          competitor: "Slower due to Drupal overhead and processing"
        },
        {
          feature: "Mobile Experience",
          portaljs: "Mobile-first responsive design",
          competitor: "Basic responsive Drupal themes"
        },
        {
          feature: "Search & Discovery",
          portaljs: "Modern search with faceted filtering",
          competitor: "Drupal Search API with limited customization"
        },
        {
          feature: "Accessibility",
          portaljs: "Built-in accessibility with modern standards",
          competitor: "Dependent on Drupal theme accessibility"
        }
      ]
    },
    {
      category: "Operations & Hosting",
      items: [
        {
          feature: "Hosting Requirements",
          portaljs: "Static hosting (CDN) + API backend",
          competitor: "Full LAMP stack with Drupal requirements"
        },
        {
          feature: "Scaling",
          portaljs: "Frontend scales globally via CDN",
          competitor: "Complex Drupal application scaling"
        },
        {
          feature: "Monitoring",
          portaljs: "Separate frontend and API monitoring",
          competitor: "Drupal application monitoring"
        },
        {
          feature: "Backup & Recovery",
          portaljs: "Simple frontend deployment + data backups",
          competitor: "Complex Drupal site and database backups"
        }
      ]
    },
    {
      ...
      items: [
        {
          feature: "Data Source Support",
          portaljs: "Any API - CKAN, custom backends, headless CMS",
          competitor: "Primarily DKAN data structures"
        },
        {
          feature: "Content Management",
          portaljs: "Choose any headless CMS or Git-based content",
          competitor: "Drupal content management system"
        },
        {
          feature: "Third-party Services",
          portaljs: "Easy integration of modern services and APIs",
          competitor: "Limited to Drupal module ecosystem"
        },
        {
          feature: "Future-proofing",
          portaljs: "Technology-agnostic, easy to migrate",
          competitor: "Tied to Drupal's evolution and lifecycle"
        }
      ]
    }
  ]
