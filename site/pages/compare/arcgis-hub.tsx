...
export default function PortalJSvsArcGISHub() {
  // Calendar link for all CTAs
  const calendarLink = "https://calendar.app.google/sn2PU7ZvzjCPo1ok6";

  const testimonials = [
    {
      quote: "ArcGIS Hub's licensing costs were becoming unsustainable as we expanded our open data program. PortalJS gave us the same functionality with complete control over our infrastructure and 60% cost savings.",
      author: "GIS Director",
      organization: "County Government, US",
      image: null
    },
    {
      quote: "We needed more than just mapping capabilities for our data portal. PortalJS allowed us to create rich data stories and custom visualizations that weren't possible with ArcGIS Hub's templated approach.",
      author: "Open Data Manager",
      ...
      items: [
        {
          ...
          competitor: "Limited to Hub themes and templates"
        },
        {
          feature: "Custom Components",
          portaljs: "Create any component with React",
          competitor: "Limited to pre-built Hub widgets"
        },
        {
          feature: "Workflow Customization",
          portaljs: "Complete control over user workflows",
          competitor: "Fixed Hub workflows with limited configuration"
        },
        {
          feature: "Branding",
          portaljs: "100% white-label capability",
          competitor: "Limited branding with Esri attribution"
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          portaljs: "Any data source - APIs, databases, files",
          competitor: "Primarily ArcGIS data sources"
        },
        {
          feature: "Non-GIS Data",
          portaljs: "Full support for all data types",
          competitor: "Limited support for non-spatial data"
        },
        {
          feature: "API Flexibility",
          portaljs: "Use any API or create custom endpoints",
          competitor: "ArcGIS REST API with limited customization"
        },
        {
          feature: "Third-party Integrations",
          portaljs: "Unlimited - integrate any service",
          competitor: "Limited to ArcGIS ecosystem partners"
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          competitor: "Esri proprietary technologies"
        },
        {
          feature: "Development Tools",
          portaljs: "Standard web development tools",
          competitor: "ArcGIS development environment required"
        },
        {
        ...
        },
        {
          ...
          competitor: "ArcGIS Online versioning system"
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          competitor: "Proprietary subscription with user limits"
        },
        {
          feature: "Cost Structure",
          portaljs: "Transparent pricing with no hidden fees",
          competitor: "Complex tiered pricing with user/credit limits"
        },
        {
          feature: "Data Ownership",
          portaljs: "100% data ownership & control",
          competitor: "Data stored on ArcGIS Online infrastructure"
        },
        {
          feature: "Exit Strategy",
          portaljs: "Take your code & deploy anywhere",
          competitor: "Data export possible but platform migration challenging"
        }
      ]
    }
  ]
