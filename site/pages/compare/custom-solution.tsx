...
export default function PortalJSvsCustomSolution() {
  // Calendar link for all CTAs
  const calendarLink = "https://calendar.app.google/sn2PU7ZvzjCPo1ok6";

  const testimonials = [
    {
      quote: "We initially planned to build our data portal from scratch, estimating 18 months and $2M in development costs. PortalJS got us to market in 6 weeks with 90% cost savings while delivering exactly what we envisioned.",
      author: "Chief Technology Officer",
      organization: "State Transportation Agency",
      image: null
    },
    {
      quote: "After 8 months of custom development, we were still struggling with basic features that PortalJS provided out-of-the-box. Switching to PortalJS accelerated our timeline by 12 months and freed our developers to focus on our core business logic.",
  ...
  const comparisonTable = [
    {
      category: "Development & Time to Market",
      items: [
        {
          feature: "Time to Launch",
          portaljs: "4-8 weeks with full customization",
          competitor: "12-24 months development cycle"
        },
        {
          feature: "Initial Investment",
          portaljs: "Low upfront cost, transparent pricing",
          competitor: "$500K-$2M+ development budget"
        },
        {
          feature: "Developer Productivity",
          portaljs: "Focus on business logic and unique features",
          competitor: "Rebuild common portal functionality from scratch"
        },
        {
          feature: "Feature Completeness",
          portaljs: "Production-ready with proven features",
          competitor: "Incomplete features and edge cases"
        }
      ]
    },
    {
      ...
      items: [
        {
          feature: "Technical Risk",
          portaljs: "Battle-tested platform with proven reliability",
          competitor: "Unproven custom code with unknown issues"
        },
        {
          feature: "Security",
          portaljs: "Regular security updates and community oversight",
          competitor: "DIY security implementation and maintenance"
        },
        {
          feature: "Bug Fixes & Updates",
          portaljs: "Community-driven improvements and fixes",
          competitor: "Internal team responsible for all maintenance"
        },
        {
          feature: "Scalability",
          portaljs: "Pre-optimized for performance and scale",
          competitor: "Custom scaling challenges and bottlenecks"
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          portaljs: "Latest React/Next.js with best practices",
          competitor: "Technology choices limited by team expertise"
        },
        {
          feature: "Performance Optimization",
          portaljs: "SSG, CDN, and performance patterns built-in",
          competitor: "Performance optimization is additional work"
        },
        {
          feature: "Mobile Responsiveness",
          portaljs: "Mobile-first design out of the box",
          competitor: "Custom responsive design implementation"
        },
        {
          feature: "Accessibility",
          portaljs: "WCAG compliance and accessibility standards",
          competitor: "Custom accessibility implementation required"
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          portaljs: "Rich charts, maps, and interactive components",
          competitor: "Custom visualization development required"
        },
        {
          feature: "Search & Filtering",
          portaljs: "Advanced faceted search with real-time filtering",
          competitor: "Custom search implementation and optimization"
        },
        {
          feature: "API Integration",
          portaljs: "Pre-built connectors for popular data sources",
          competitor: "Custom API integration for each data source"
        },
        {
          feature: "Content Management",
          portaljs: "Flexible CMS options and Git-based workflows",
          competitor: "Custom content management system development"
        }
      ]
    },
    {
      ...
      items: [
        {
          feature: "Team Expertise Required",
          portaljs: "Standard web development skills",
          competitor: "Full-stack expertise across entire technology stack"
        },
        {
          feature: "Knowledge Transfer",
          portaljs: "Documentation and community resources",
          competitor: "Institutional knowledge trapped with developers"
        },
        {
          feature: "Future Enhancements",
          portaljs: "Benefit from community improvements and features",
          competitor: "All new features require custom development"
        },
        {
          feature: "Technology Evolution",
          portaljs: "Platform evolves with modern web standards",
          competitor: "Risk of technical debt and outdated stack"
        }
      ]
    }
  ]
                          ...
                          <tr key={item.feature} className="hover:bg-slate-50 dark:hover:bg-slate-800/70 transition-colors">
                            ...
                            <td className="px-4 py-5 text-base text-slate-700 dark:text-slate-300">
                              <div className="flex items-center">
                                <svg className="w-5 h-5 mr-3 text-green-500 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
